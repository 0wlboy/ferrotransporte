...
export interface PickedImage {
  ...
  /** Alto en píxeles */
  height: number;
  /** Representación en base64 de la imagen */
  base64?: string;
}
...
export interface ProfilePickerProps {
  ...
  /** URI inicial para previsualizar una imagen ya existente (ej: foto de perfil actual) */
  initialUri?: string;
}
...
export function ProfilePicker({
  ...
  // Estado local: URI previsualizada — arranca con initialUri si se provee
  ...
  const handlePickImage = async () => {
    ...
    const result = await ImagePicker.launchImageLibraryAsync({
      ...
      quality: 0.4, // Calidad 85% para balance tamaño/calidad
      allowsMultipleSelection: false, // Solo una imagen a la vez
      base64: true, // Habilitar la codificación base64 para evitar errores de red al convertir URI en nativo
    });
  ...
  return (
    <View style={[styles.container, containerStyle]}>
      ...
      <TouchableOpacity
        ...
        style={[styles.circle, hasError && styles.circleError]}
      >
        {previewUri ? (
      ...
      <Text style={[styles.label, hasError && styles.labelError]}>
        {previewUri ? "Cambiar Foto de Perfil" : "Añade una Foto de Perfil"}
      </Text>
