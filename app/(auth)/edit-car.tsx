...
export default function EditCar() {
    ...
    const original = useMemo(
        () => ({
            ...
            maletero_amplio: car?.maletero_amplio != null ? String(car.maletero_amplio) : "",
        }),
    ...
    const [maletero_amplio, setMaletero_amplio] = useState(original.maletero_amplio);
        ...
        return (
            <SafeAreaView style={styles.safeContainer} edges={['top', 'left', 'right']}>
                ...
                <View style={styles.loadingContainer}>
                    ...
                    <MaterialCommunityIcons name="car-off" size={60} color="rgba(255,255,255,0.6)" />
            ...
            >
                ...
                >
                    ...
                    <View style={styles.headerContainer}>
                        ...
                        <Text style={styles.headerTitle}>Editar Informacion del Vehiculo</Text>
